...
(function (lola) {
    var Command = function () {
        ...
        this.execute = function (params) {
            ...
            setTimeout( function(){ status('test1: executing');}, 1);
            setTimeout( function(){ status('test1: getting param a');}, 500 );
            setTimeout( function(){ status('test1: getting param b');}, 1000 );
            setTimeout( function(){ status('test1: adding params');}, 1500 );
