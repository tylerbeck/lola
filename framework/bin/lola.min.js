...
this.support.domEval?d.appendChild(document.createTextNode(a)):d.text=a;c.insertBefore(d,c.firstChild);c.removeChild(d)},loadScript:function(a,c){var g=document.getElementsByTagName("head")[0];if(!g)g=document.documentElement;var h=document.createElement("script");typeof c=="function"&&d.event.addListener(h,"load",function(){c.apply()});h.src=a;g.insertBefore(h,g.firstChild)},registerModule:function(a){var c=a.getNamespace();d.debug("lola::registerModule - "+c);a.hasOwnProperty("getDependencies")&&
typeof a.getDependencies=="function"&&(d.dependencies[c]=a.getDependencies());d.extend(d.getPackage(d,c),a);d.extend(d.Selector.prototype,a.getSelectorMethods());delete a.getSelectorMethods;a.initialize&&typeof a.initialize==="function"&&d.addInitializer(function(){a.initialize()});a.preinitialize&&typeof a.preinitialize==="function"&&a.preinitialize()},safeDelete:function(a,c){for(var d=c?a[c]:a,h=this.safeDeleteHooks.length-1;h>=0;h--)if(d){var j=this.safeDeleteHooks[h];j.fn.call(j.scope,d)}a&&
c&&delete a[c]},toString:Object.prototype.toString,checkArgs:function(a,c,g){for(var h=true,j=[],k=c.length-1;k>=0;k--)if(c[k][1]===void 0||c[k][1]===null)h=false,j.push(c[k][0]+" is not set!");h||(console.groupCollapsed?console.groupCollapsed(a):console.group(a),d.type.get(g)=="array"&&g.forEach(function(a){console.info(a)}),j.forEach(function(a){console.warn(a)}),console.groupEnd());return h},addInitializer:function(a){d.initializers.push(a)},debug:function(){d.debugMode&&console.log("["+d.now()+
"]",arguments.join(" "))},now:function(){return(new Date).getTime()},__:function(a){return a.length==1?a[0]:a},upgradeObjectPrototype:function(){if(!Object.keys)Object.keys=function(a){var c=[],d;for(d in a)Object.prototype.hasOwnProperty.call(a,d)&&c.push(d);return c};if(!Object.forEach)Object.forEach=function(a,c,d){if(a===void 0||a===null)throw new TypeError;a=Object(a);if(typeof c!=="function")throw new TypeError;for(var h in a)a.hasOwnProperty(h)&&c.call(d,a[h],h,a)}},Selector:function(a,c){return this.initialize(a,
c)},Module:function(){return this},URL:function(a){return this.init(a)}};d.Selector.prototype={elements:[],initialize:function(a,e){if(typeof a==="string")if(c.Sizzle)this.elements=Sizzle(a,e);else try{e||(e=document);var d=e.querySelectorAll(a),h=d.length;this.elements=[];for(var j=0;j<h;j++)this.elements.push(d.item(j))}catch(k){console.log("Exception:",a)}else this.elements=Array.isArray(a)?a:[a];return this},identify:function(){this.forEach(function(a){if(!a.id)a.id="lola-guid-"+d.guid++});return this},
get:function(a){a==void 0&&(a=0);return this.elements[a]},getAll:function(){return this.elements},count:function(){return this.elements.length},concat:function(a,c){if(a instanceof d.Selector)this.elements=this.elements.concat(a.getAll());else if(a instanceof Array)for(var g;g=a.pop();)this.concat(g,c);else this.elements.push(a);if(c==void 0||c===true)this.elements=d.array.unique(this.elements);return this}};d.Module.prototype={initialize:function(){},getNamespace:function(){return""},getDependencies:function(){return[]},
getSelectorMethods:function(){return{}}};d.URL.prototype={protocol:"",domain:"",path:"",page:"",vars:{},hash:"",init:function(a){this.parse(a);return this},parse:function(a){a=a.split("#",2);this.hash=a[1]?a[1]:"";var c={},a=a[0].replace(/[?&]+([^=&]+)=([^&]*)/gi,function(a,f,d){c[f]=d;return""});this.vars=c;a=a.split(":");a.length==2?(this.protocol=a[0],a=a[1].substr(2).split("/"),this.domain=a.shift()):a=a[0].split("/");this.page=a.pop();this.path=this.domain==""?"":"/";if(a.length>0)this.path=
this.path+a.join("/")+"/"},toString:function(){var a=[];Object.forEach(this.vars,function(c,e){a.push(e+"="+c)});var c=a.length?"?"+a.join("&"):"",d=this.hash==""?"":"#"+this.hash;return this.protocol!=""?this.protocol+"://"+this.domain+this.path+this.page+c+d:this.path+this.page+c+d}};var a=function(a,c){return new d.Selector(a,c)};d.upgradeObjectPrototype();delete d.upgradeObjectPrototype;d.extend(a,d,true);d=a;c.$=d;c.lola=d;d.url=new d.URL(c.location.href);d.debugMode=d.url.vars.debug=="true";
document.readyState==="complete"?d.initialize(c):document.addEventListener?(document.addEventListener("DOMContentLoaded",d.initialize,false),c.addEventListener("load",d.initialize,false)):document.attachEvent&&(document.attachEvent("onreadystatechange",d.initialize),c.attachEvent("onload",d.initialize))})(window);
...
a+".apply( this.ctx, arguments );}")}delete c.graphics.preinitialize;c.g=c.graphics},initialize:function(){c.debug("lola.graphics::initialize");if(!c)throw Error("lola not defined!");delete c.graphics.initialize},getNamespace:function(){return"graphics"},getDependencies:function(){return["math.point","math.vector"]},register2dContext:function(d,a){var f=d.getContext("2d"),a=a==void 0?c(d).identify().attr("id"):a,e=c(d).getData(this.getNamespace(),true);if(e.contexts2d==null)e.contexts2d=[];e.contexts2d.push(a);
this.map2d[a]=f},remove2dContext:function(d){if((d=c(d).getData(this.getNamespace(),false))&&d.contexts2d)for(var a;a=d.contexts2d.pop();)delete this.map2d[a]},get2dContext:function(c){return this.map2d[c]},resolveContext:function(d){typeof d==="string"&&(d=this.get2dContext(d));return d||c.graphics.ctx},setContext:function(c){this.ctx=this.resolveContext(c)},reset2dContext:function(d){typeof d=="string"&&(d=this.resolveContext(d));d&&c.util.copyPrimitives(this.reset2d,d)},registerStyle:function(d,
a){var f={};c.util.copyPrimitives(a,f);this.styles2d[d]=f},removeStyle:function(c){delete this.styles2d[c]},registerRoutine:function(c,a){this.routines[c]=a},removeRoutine:function(c){delete this.routines[c]},executeRoutine:function(c){if(typeof this.routines[c]=="function")this.routines[c](this.ctx)},applyStyle:function(d,a){var a=this.resolveContext(a),f=typeof d=="string"?this.styles2d[d]||this.reset2d:d;c.util.copyPrimitives(this.reset2d,a);c.util.copyPrimitives(f,a)},draw:function(d,a){d.draw&&
typeof d.draw==="function"&&d.draw(c.graphics.ctx,a)},clear:function(c){c=this.resolveContext(c);c.clearRect(0,0,c.canvas.width,c.canvas.height)},getSelectorMethods:function(){return{register2dContext:function(){this.forEach(function(d){c.graphics.register2dContext(d)});return this}}}})})(lola);
...
this.getRequestObject();n.open(e,a,h,l,m);n.setRequestHeader("Content-type","application/x-www-form-urlencoded");for(a=0;a<g.length;a++)try{n.setRequestHeader(g[a].name,g[a].value)}catch(o){}if(d!=null&&c.type.get(d)!="string"){var g=[],q;for(q in d)g.push(q+"="+c.string.encode(d[q]));d=g.join("&")}n.onreadystatechange=function(){j.call(k)};n.send(d);return n},load:function(a){this.request=this.makeRequest(this.url,a,this.method,this.headers,this.async,this.readyStateChange,this,this.user,this.password)},
...
this.url),c.event.trigger(this,"fault",false,false,this.request))}},responseText:function(){return this.ready||!this.async?this.request.responseText:false},responseXML:function(){return this.ready||!this.async?this.request.responseXML:false}};d.AsyncRequest.prototype=d.Request.prototype;d.SyncRequest.prototype=d.Request.prototype;d.Transform.prototype={xml:null,xsl:null,xslParams:null,xmlParams:null,xslCacheId:"",resultNodes:[],init:function(a,d,e,g,h,j){this.xmlParams=d;this.xslParams=g;this.transformParams=
h;this.xslCacheId=j||"";if(c.type.get(e)=="string"){if(a=e,e=c.http.getCachedXsl(a),!e)throw Error('unknown xsl cache id: "'+a+'"');}else this.xsl=e;if(this.xsl&&this.xml)c.event.addListener(this.xsl,"result",this.checkStates,true,0,this),c.event.addListener(this.xsl,"fault",this.handleXSLFault,true,0,this),c.event.addListener(this.xml,"result",this.checkStates,true,0,this),c.event.addListener(this.xml,"fault",this.handleXMLFault,true,0,this),this.checkStates();else throw Error("transform error!");
},checkStates:function(){if(this.xml.ready&&this.xsl.ready)this.xslCacheId&&this.xslCacheId!=""&&c.http.cacheXsl(this.xslCacheId,this.xsl),this.resultNodes=c.http.transform(this.xml.responseXML(),this.xsl.responseXML(),this.transformParams),c.event.trigger(this,"result",true,true,this.resultNodes)},handleXSLFault:function(){c.event.trigger(this,"fault",true,true,"xsl fault")},handleXMLFault:function(){c.event.trigger(this,"fault",true,true,"xml fault")},load:function(){this.xml.request||this.xml.send(this.xmlParams);
this.xsl.request||this.xsl.send(this.xslParams)},cancel:function(){c.event.removeListener(this.xsl,"result",this.checkStates,true);c.event.removeListener(this.xsl,"fault",this.handleXSLFault,true);c.event.removeListener(this.xml,"result",this.checkStates,true);c.event.removeListener(this.xml,"fault",this.handleXMLFault,true);try{this.xsl.abort()}catch(a){}try{this.xml.abort()}catch(d){}},getResultNodes:function(){return this.resultNodes}};c.registerModule(d)})(lola);
...
(function(c){var d={src:"tests.xml",index:-1,executables:[],current:null,preinitialize:function(){c.debug("lola.test::preinitialize");if(!c)throw Error("lola not defined!");delete c.test.preinitialize},initialize:function(){c.debug("lola.test::initialize");if(!c)throw Error("lola not defined!");delete c.test.initialize},getNamespace:function(){return"test"},getDependencies:function(){return[]},setSource:function(a){d.src=a},start:function(){console.log("lola.test.run: "+d.src);var a=new c.http.SyncRequest(d.src);
a.load();a=a.responseXML();d.executables=[];if(a.documentElement.tagName=="tests")for(var a=a.documentElement,f=a.childNodes.length,e=0;e<f;e++){var g=a.childNodes[e];if(g.nodeType==1)switch(g.nodeName.toLowerCase()){case "script":g=new d.Script(g);d.executables.push(g);break;case "test":g=new d.Test(g),d.executables.push(g)}}d.index=-1;d.next()},next:function(){d.index++;if(d.index<d.executables.length){var a=d.executables[d.index];c.test.current=a;a.execute()&&setTimeout(function(){d.next()},10)}else d.complete()},
complete:function(){console.log("lola.test.complete")},getSelectorMethods:function(){return{}},Script:function(a){return this.init(a)},Test:function(a){return this.init(a)}};d.Script.prototype={name:"",value:"",init:function(a){if(a.hasAttribute("name"))this.name=a.attributes.getNamedItem("name").nodeValue;for(var c="",d=0;d<a.childNodes.length;d++)c+=a.childNodes[d].data;this.value=c;return this},execute:function(){console.log("executing",'"'+this.name+'"',"script");c.evaluate(this.value);return true}};
d.Test.prototype={name:void 0,result:void 0,assert:"==",compareTo:void 0,test:void 0,async:false,passed:void 0,error:"",init:function(a){this.name=a.attributes.getNamedItem("name").nodeValue;if(a.hasAttribute("async"))this.async=a.attributes.getNamedItem("async").nodeValue=="true";if(a.hasAttribute("equals"))this.assert="equals";else if(a.hasAttribute("strictlyEquals"))this.assert="strictlyEquals";else if(a.hasAttribute("doesNotEqual"))this.assert="doesNotEqual";else if(a.hasAttribute("greaterThan"))this.assert=
"greaterThan";else if(a.hasAttribute("lessThan"))this.assert="lessThan";else if(a.hasAttribute("greaterThanOrEquals"))this.assert="greaterThanOrEquals";else if(a.hasAttribute("lessThanOrEquals"))this.assert="lessThanOrEquals";var c=a.attributes.getNamedItem(this.assert).nodeValue;switch(a.attributes.getNamedItem("type").nodeValue){case "float":this.compareTo=parseFloat(c);break;case "int":this.compareTo=parseInt(c);break;case "bool":this.compareTo=c==="true";break;default:this.compareTo=String(c)}for(var c=
"",d=0;d<a.childNodes.length;d++)c+=a.childNodes[d].data;this.test=c;return this},execute:function(){console.log(this.name);try{return this.async?(c.evaluate(this.test),false):(this.result=eval(this.test),this.compare(),true)}catch(a){return this.passed=false,this.error="failed due to error: "+a.message,console.error("    ",this.error),console.log("    ",a),true}},setResult:function(a){this.result=a;this.compare();c.test.next()},compare:function(){switch(this.assert){case "equals":this.passed=this.result==
this.compareTo;if(!this.passed)this.error="assertion false: "+this.result+" == "+this.compareTo;break;case "strictlyEquals":this.passed=this.result===this.compareTo;if(!this.passed)this.error="assertion false: "+this.result+" === "+this.compareTo;break;case "doesNotEqual":this.passed=this.result!=this.compareTo;if(!this.passed)this.error="assertion false: "+this.result+" != "+this.compareTo;break;case "greaterThan":this.passed=this.result>this.compareTo;if(!this.passed)this.error="assertion false: "+
this.result+" > "+this.compareTo;break;case "lessThan":this.passed=this.result<this.compareTo;if(!this.passed)this.error="assertion false: "+this.result+" < "+this.compareTo;break;case "greaterThanOrEquals":this.passed=this.result>=this.compareTo;if(!this.passed)this.error="assertion false: "+this.result+" >= "+this.compareTo;break;case "lessThanOrEquals":this.passed=this.result<=this.compareTo;if(!this.passed)this.error="assertion false: "+this.result+" <= "+this.compareTo;break;default:if(this.passed=
this.result==this.compareTo,!this.passed)this.error="assertion false: "+this.result+" == "+this.compareTo}if(!this.passed)this.error="failed, "+this.error,console.error("    ",this.error)}};c.registerModule(d)})(lola);
